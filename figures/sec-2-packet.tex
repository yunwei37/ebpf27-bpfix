...
verifier: R1 invalid mem access 'scalar'
  ...
  \vspace{3pt}
  \noindent\textbf{\footnotesize (b) Compiler-lowering rejection (cilium nat.h)}
  \begin{lstlisting}[style=bpfix,language=C,
