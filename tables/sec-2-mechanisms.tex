\begin{table}[t]
  \centering
  \caption{The 191 developer bugs fall into 12 source mechanisms. A mechanism is the specific source-level error the developer made; the \emph{Cases} column gives how many bugs each accounts for.}
